<template>
    <section class="bg-gray-900 text-white">
        <div class="mx-auto lg:flex lg:h-screen lg:items-center px-4 py-32">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <p class="mx-auto mt-4 max-w-xl sm:text-xl/relaxed">Lorem ipsum dolor sit amet consectetur, adipisicing
                    elit.
